...
def generate_outage_map(node_feature, edge_feature, list_folder, weather_event, wi_folder, datasets):
    """
    ...
    with h5py.File(existing_dataset, "w") as f:
    ...
    for index_event, weather_event in enumerate(all_weather_events):
        ...
        plotTreeWithProb(G, meanProb, weather_event, pos)
