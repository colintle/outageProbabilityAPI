...
@click.option('--features', type=click.Choice(['temp', 'dwpt', 'rhum', 'prcp', 'snow', 'wdir', 'wspd', 'wpgt', 'pres', 'tsun'], case_sensitive=True), multiple=True, required=True, help='Weather features to process.')
